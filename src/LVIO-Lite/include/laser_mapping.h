#ifndef lvio_lite_LASER_MAPPING_H
#define lvio_lite_LASER_MAPPING_H
...
class LaserMapping {
  ...
  private:
   ...
   private:
    ...
    /////////////////////////  render  //////////////////////////////////////////////////////////////
    ros::Publisher pub_keyframe_;  // rgb render
    std::deque<Cloud6D_t> keyFrames_;
    std::mutex mut_keyFrame_;
    std::thread* fov_segment_thread_ = nullptr;
    bool b_pub_keyframe_;
    void SaveKeyFrame6D();
    void FovSegment_pub_thread();
...
#endif  // lvio_lite_LASER_MAPPING_H